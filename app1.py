...
def app():
    ...
    st.title('AfriCDSA')
    st.markdown('## Crop Prediction app')
    st.subheader("Model used : Efficient-Net With an Accuracy of : 99.65% ")
    st.markdown(' ### By Joseph Gitau')
    st.write("Upload your Plant's Leaf Image and Get Predictions if Your Plant is Healthy or Not!")
    st.write("")
